...
\fancyhf{}
\lhead{\texttt{Συμμετρική Κρυπτογραφία}}
\rhead{\texttt{Φίλης Χάρης ΑΕΜ:189}}
\chead{}
\lfoot{\texttt{$1^{o}$ Project }}
\cfoot{}
\rfoot{\texttt{Page \thepage}}
% Set the right side of the footer to be the page number
\renewcommand{\footrulewidth}{0.5pt} % Thickness of the footer ruler
...
\end{center}
\end{titlepage}
\section*{Aσκηση 2.3 - Vigenere Decrypt}
Στην πρώτη άσκηση υλοποιήθηκε ο αλγόριθμος που βρίσκει το μέγεθος του κλειδιού και αποκρυπτογραφεί μήνυμα που έχει κωδικοποιηθεί με τον αλγόριθμο του Vigenere. 

Για την εύρεση του μεγέθους κλειδιού χρησιμοποιήθηκε το test Friedman. Σύμφωνα με αυτόν τον αλγόριθμο 
\section*{Άσκηση 2 - 2.4}

\section*{Άσκηση 3 - 2.5}
\section*{Ασκηση 4 - 2.6}
\section*{Άσκηση 5 - 3.6}
\section*{Άσκηση 6 - 3.8}
\section*{Άσκηση 7 - 3.9}
\section*{Άσκηση 8 - 3.11}
\section*{Άσκηση 9 - 4.8}
\section*{Άσκηση 10 - (CTF-Like)}
\end{document}
